...
import { ArrowRight, Truck, FileText, Clock, Info, ShieldAlert, Phone, Mail, Package, Container, Anchor } from "lucide-react";
import { Button } from "@/components/ui/button";
import { PageHero } from "@/components/layout/page-hero";
import { EVENT } from "@/config/event";

export const metadata: Metadata = {
  title: `Forwarding & Clearing — Exhibitor Logistics | ${EVENT.name}`,
  description: `Logistics, freight forwarding, customs clearance, and machinery handling information for exhibitors at ${EVENT.fullName} ${EVENT.year} at ${EVENT.venue.name}, ${EVENT.venue.city}.`,
};
...
export default function ExhibitorLogisticsPage() {
  return (
    <div className="bg-[#0b1329] text-white min-h-screen relative overflow-hidden">
      ...
      {/* Background SVG Vectors: Logistics & Freight Shipping Theme */}
        ...
        <svg className="w-full h-full opacity-25" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <pattern id="logistics-grid" width="50" height="50" patternUnits="userSpaceOnUse">
              ...
              <circle cx="50" cy="50" r="1" fill="rgba(59, 130, 246, 0.4)" />
            </pattern>

            {/* Container Pattern Texture */}
            <pattern id="container-texture" width="12" height="40" patternUnits="userSpaceOnUse">
              <line x1="0" y1="0" x2="0" y2="40" stroke="rgba(239, 68, 68, 0.15)" strokeWidth="2" />
              <line x1="6" y1="0" x2="6" y2="40" stroke="rgba(255, 255, 255, 0.03)" strokeWidth="2" />
            </pattern>
          ...
          {/* Dotted Route Trajectories & Global Shipping Paths */}
          <path d="M -100 250 Q 400 50, 900 350 T 1900 150" fill="none" stroke="url(#redTrail)" strokeWidth="2" strokeDasharray="10 8" />
          <path d="M -200 700 Q 500 950, 1100 600 T 2000 800" fill="none" stroke="url(#blueTrail)" strokeWidth="2.5" strokeDasharray="6 6" />

          {/* Shipping Container Line-Art (Top Right) */}
          <g transform="translate(1000, 140) scale(1.2)" opacity="0.12" stroke="#3b82f6" strokeWidth="1.5" fill="none">
            <rect x="0" y="0" width="220" height="110" rx="4" />
            <line x1="110" y1="0" x2="110" y2="110" strokeWidth="2" />
            {/* Vertical Container Ribs */}
          ...
          {/* Cargo Ship Anchor & Dock Vector (Middle Left) */}
          <g transform="translate(-40, 520)" opacity="0.15" stroke="#ef4444" strokeWidth="2" fill="none">
          ...
          {/* Logistics Target Node Matrix (Bottom Right) */}
          <g transform="translate(900, 850)" opacity="0.18">
            <circle cx="100" cy="100" r="80" stroke="#3b82f6" strokeWidth="1.5" fill="none" strokeDasharray="4 4" />
            <circle cx="100" cy="100" r="40" stroke="#ef4444" strokeWidth="1.5" fill="none" />
            <circle cx="100" cy="100" r="6" fill="#ef4444" />
            <line x1="100" y1="0" x2="100" y2="200" stroke="#3b82f6" strokeWidth="1" strokeDasharray="4 4" />
            <line x1="0" y1="100" x2="200" y2="100" stroke="#3b82f6" strokeWidth="1" strokeDasharray="4 4" />
          </g>
        </svg>
      </div>
      ...
      <section className="relative py-20 lg:py-24 z-10">
        <div className="max-w-[var(--max-width)] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 bg-[#111c38]/80 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-slate-800 hover:border-blue-500/30 transition-all duration-300 relative overflow-hidden group shadow-xl">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 bg-red-500/20 text-red-400 border border-red-500/30 rounded">
                    Under Finalization
                  </span>
                </div>
          ...
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {LOGISTICS_STEPS.map((step) => {
              ...
              return (
                <div
                  key={step.title}
                  className="bg-[#111c38]/60 hover:bg-[#111c38] rounded-2xl p-7 border border-slate-800 hover:border-red-500/40 hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-300 backdrop-blur-md group relative flex flex-col justify-between"
                >
                  <div>
                    <div className="flex items-center justify-between mb-6">
                      <div className="w-12 h-12 rounded-xl bg-red-600/10 border border-red-500/20 flex items-center justify-center group-hover:scale-110 group-hover:bg-red-600/20 transition-all">
          ...
          <div className="mt-12 grid lg:grid-cols-3 gap-8 items-stretch">
            <div className="lg:col-span-2 bg-gradient-to-r from-[#111c38]/90 to-[#0b1329]/90 border border-slate-800 rounded-2xl p-8 backdrop-blur-md relative overflow-hidden flex flex-col justify-between">
              ...
              <div>
                ...
                <div className="mt-6 grid sm:grid-cols-2 gap-4">
                  <div className="flex items-center gap-3.5 p-3.5 bg-[#0b1329]/80 rounded-xl border border-slate-800">
              ...
              <div className="mt-8 pt-6 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
                ...
                <Link href="/contact">
                  <Button variant="primary" size="md" className="bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl gap-2 shadow-lg shadow-red-600/20">
            ...
            <div className="bg-[#111c38]/50 border border-slate-800 rounded-2xl p-8 backdrop-blur-md flex flex-col justify-between">
              <div>
